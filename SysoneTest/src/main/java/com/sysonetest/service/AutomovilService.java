...
public class AutomovilService {
    ...
    public void deleteAutomovil(Automovil automovilRequest) {
        List<Comodidad> lista = automovilRequest.getComodidades();
        this.automovilRepository.delete(automovilRequest);
    }
